...
class ShowVertifyPage extends AbstractPage
{
	...
	private function _activeUser()
	{
		...
		list($userID, $planetID) = PlayerUtil::createPlayer($userData['universe'], $userData['userName'], $userData['password'], $userData['email'], $userData['language'], $userData['planetName'], $validationID, $userData['encodage']);
	...
	{	
		...
		$this->redirectTo('game.php?page=intro');
	}

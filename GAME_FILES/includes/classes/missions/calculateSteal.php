...
{	
	...
	foreach($attackFleets as $FleetID => $Attacker)
	{
		...
		{
			$getShipInfo	= $GLOBALS['DATABASE']->getFirstRow("SELECT shipAttack, shipBouclier, shipCoque, shipFret FROM ".VARS_USER." WHERE varId = ".$Element.";");
			
			$SortFleets[$FleetID]		+= $getShipInfo['shipFret'] * $amount;
		}

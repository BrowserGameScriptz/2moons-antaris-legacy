	...
	function buildCache()
	{
		...
		while($varsRow = $GLOBALS['DATABASE']->fetch_array($varsResult)) {
			...
			$pricelist[$varsRow['elementID']]	= array(
				...
				'isHyperspace'	=> $varsRow['isHyperspace'],
				'class'			=> $varsRow['class'],
				'shiptype'		=> $varsRow['shiptype'],
				'tech'			=> $varsRow['speedTech'],
				'time'			=> $varsRow['timeBonus'],
				'atk'			=> $varsRow['attack'],
				'defed'			=> $varsRow['defend'],
				'coque'			=> $varsRow['coque'],
				'bonus'			=> array(
			...
			switch($varsRow['class']) {
				...
				break;
				case 1100: 
					$reslist['infra'][]	= $varsRow['elementID'];
				break;
				case 1200: 
					$reslist['composant'][]	= $varsRow['elementID'];
				break;
			}
		}

...
// Modules
define('MODULE_OVERVIEW'			, 0);
define('MODULE_ACHIEVEMENTS'		, 1);
define('MODULE_FLEET_EVENTS'		, 2);
define('MODULE_ALLIANCE'			, 3);
define('MODULE_LIVENEWS'			, 4);
define('MODULE_TOWER'				, 5);
define('MODULE_TECHTREE'			, 6);
define('MODULE_GALAXY'				, 7);
define('MODULE_MISSION_TRANSPORT'	, 8);
define('MODULE_MISSION_STATION'		, 9);
define('MODULE_MISSION_RECYCLE'		, 10);
define('MODULE_TPORTAL'				, 11);
define('MODULE_SPACECENTER'			, 12);
define('MODULE_EXPLORATIONS'		, 13);
define('MODULE_BUILDING'			, 14);
define('MODULE_RESEARCH'			, 15);
define('MODULE_SPECIALIZED'			, 16);
define('MODULE_DEFENSE'				, 17);
define('MODULE_POPULATION'			, 18);
define('MODULE_SEARCH'				, 19);
define('MODULE_MARKET'				, 20);
define('MODULE_BUNKER'				, 21);
define('MODULE_BANK'				, 22);
define('MODULE_RESSOURCE_LIST'		, 23);
define('MODULE_SIMULATOR_PORTAL'	, 24);
define('MODULE_SIMULATOR_SPACE'		, 25);
define('MODULE_IMMUNITY'			, 26);
define('MODULE_PLANET_CLOAK'		, 27);
define('MODULE_LOTTERY'				, 28);
define('MODULE_REDEEM'				, 29);
define('MODULE_MESSAGES'			, 30);
define('MODULE_STATISTICS'			, 31);
define('MODULE_SETTINGS'			, 32);
define('MODULE_GESTION'				, 33);
define('MODULE_CHAT'				, 34);
define('MODULE_ACHAT'				, 35);
define('MODULE_FAQ'					, 36);
define('MODULE_SUPPORT'				, 37);
define('MODULE_BANNED'				, 38);
define('MODULE_BATTLEHALL'			, 39);
define('MODULE_CREATESHIP'			, 40);
define('MODULE_PLAYERCARD'			, 41);
define('MODULE_MISSION_ATTACK'		, 42);

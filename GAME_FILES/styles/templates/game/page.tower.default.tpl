...
<div id="page_contenu"><h1>{$LNG.ls_tmanag_1}</h1><div id="page_tour_gestion">	<div class="onglet">
				...
				<div id="msg_formulaire" class="msg_formulaire"></div>
				
				<div class="image_planete">
					<img onclick="location.href='game.php?page=Tower&mode=newimage';" src="https://cdngames.antaris-legacy.eu/media/ingame/planet/{$planetimage}.jpg" />
				...
				<div class="explication">
					...
					<div class="margin_liste">
						...
						{else}
						- <a href="?page=Tower&mode=delete">{$LNG.ls_tmanag_17}.</a>

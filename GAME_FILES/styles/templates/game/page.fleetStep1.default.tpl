       ...
       <div name="conteneur_coordonnees">
        ...
        <div name="conteneur_champ">
            <!-- Si la mission nécessite l'affichage des raccourcis pour les coordonnées -->
                             <h3>Shortcut to your planets ({$PlanetCount})<img onmouseout="cache();" onmouseover="montre('Show / hide this part of the form.');" src="https://cdngames.antaris-legacy.eu/media/ingame/image/mission/joystick.png" class="switch"></h3>
...
{foreach $colonyList as $ColonyRow}
                      ...
                      {/foreach}
                                       </div><h3>Parameters and flight details<img onmouseout="cache();"  src="https://cdngames.antaris-legacy.eu/media/ingame/image/mission/joystick.png" class="switch"></h3>
  <div id="settings">  
                        <table>
                            <!-- Détail sur le fret et la vitesse globale de la flotte -->
                            <tbody><tr>
                                <td><img src="https://cdngames.antaris-legacy.eu/media/ingame/image/mission/boite.png"> Capacity :</td>
                                <td id="storage">-</td>
                                <td><img src="https://cdngames.antaris-legacy.eu/media/ingame/image/mission/vitesse.png"> Speed :</td>
                            ...
                            <tr>
                                <td><img src="https://cdngames.antaris-legacy.eu/media/ingame/image/mission/horloge.png"> Time :</td>
                               <td id="duration">-</td>
                                <td><img src="https://cdngames.antaris-legacy.eu/media/ingame/image/mission/funnel.png"> Comsuption :</td>
                                <td id="consumption">-</td>
                                <td><img src="https://cdngames.antaris-legacy.eu/media/ingame/image/mission/parametre.png"> Reactors :</td>
                    ...
                    <div style="color : grey; font-style : italic;"> You can change the speed of your fleet by clicking the percentage next to "reactors". <br> Elements <span class="cyan">blue</span> represent the meaning "go way" and the elements <span class="rouge">red</span> represent the meaning "return way."</div></div>
					     ...
					     <!-- Si la mission autorise l'affichage des ressources dans le formulaire -->
                                             <h3>Ressources <img onmouseout="cache();" src="https://cdngames.antaris-legacy.eu/media/ingame/image/mission/joystick.png" class="switch"></h3>
                         <div id="form_ressource">
                             <div id="msg_fret"></div>
                                  ...
                                  <img name="maximum" src="https://cdngames.antaris-legacy.eu/media/ingame/image/mission/drapeau_bleu.png" onclick="javascript:maxResourceBis('metal');updateVars();">
                              </div>
                                  ...
                                  <img name="maximum" src="https://cdngames.antaris-legacy.eu/media/ingame/image/mission/drapeau_bleu.png" onclick="javascript:maxResourceBis('crystal');updateVars();">
                              </div>
                                                          <div class="ressource">
                                  ...
                                  <img name="maximum" src="https://cdngames.antaris-legacy.eu/media/ingame/image/mission/drapeau_bleu.png" onclick="javascript:maxResourceBis('deuterium');updateVars();">
                              </div>
                                                          <div class="ressource">
                                  ...
                                  <img name="maximum" src="https://cdngames.antaris-legacy.eu/media/ingame/image/mission/drapeau_bleu.png" onclick="javascript:maxResourceBis('elyrium');updateVars();">
                              </div>
                    ...
                    <!-- Si la mission autorise l'affichage des populations dans le formulaire -->
                                             <h3>Populations<img onmouseout="cache();" onmouseover="montre('Afficher/cacher cette partie du formulaire.');" src="https://cdngames.antaris-legacy.eu/media/ingame/image/mission/joystick.png" class="switch"></h3>
                         <div id="form_population">
                            ...
                            <img name="maximum" src="https://cdngames.antaris-legacy.eu/media/ingame/image/mission/drapeau_bleu.png" onclick="javascript:maxPop('population{$PopRow.id}');">
                        </div>
                             {/foreach}

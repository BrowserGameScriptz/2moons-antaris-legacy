...
<div id="recherche_aide" class="categorie">	
	...
	<h2>Faire une recherche dans la FAQ</h2>		Ici, vous trouverez les réponses à vos questions les plus fréquentes. Cette page sera mise à jour avec<br /> 
						...
						*}
						...
						<h4 id="titre_93" onclick="javascript:Faq.afficherCacher(93);">	<span name="titre">■ {$LNG.ls_faq_1} ?</span>	</h4><div id="reponse_93" class="reponse_faq">{$LNG.ls_faq_2}</div><h4 id="titre_100" onclick="javascript:Faq.afficherCacher(100);">	<span name="titre">■ {$LNG.ls_faq_3} ? </span>	</h4><div id="reponse_100" class="reponse_faq">{$LNG.ls_faq_4}</div><h4 id="titre_102" onclick="javascript:Faq.afficherCacher(102);">	<span name="titre">■ {$LNG.ls_faq_5} ?</span>	</h4><div id="reponse_102" class="reponse_faq">{$LNG.ls_faq_6}</div><h4 id="titre_56" onclick="javascript:Faq.afficherCacher(56);">	<span name="titre">■ {$LNG.ls_faq_7} ?</span>	</h4><div id="reponse_56" class="reponse_faq">{$LNG.ls_faq_8}</div><h4 id="titre_68" onclick="javascript:Faq.afficherCacher(68);">	<span name="titre">■ {$LNG.ls_faq_9} ?</span>	</h4><div id="reponse_68" class="reponse_faq">{$LNG.ls_faq_10}</div><h4 id="titre_86" onclick="javascript:Faq.afficherCacher(86);">	<span name="titre">■ {$LNG.ls_faq_11} ?</span>	</h4><div id="reponse_86" class="reponse_faq">{$LNG.ls_faq_12}</div><h4 id="titre_1" onclick="javascript:Faq.afficherCacher(1);">	<span name="titre">■ {$LNG.NOUVEAUTE_254}</span>	</h4><div id="reponse_1" class="reponse_faq">{$LNG.NOUVEAUTE_255}</div><h4 id="titre_2" onclick="javascript:Faq.afficherCacher(2);">	<span name="titre">■ {$LNG.NOUVEAUTE_256}</span>	</h4><div id="reponse_2" class="reponse_faq">{$LNG.NOUVEAUTE_257}</div><h4 id="titre_3" onclick="javascript:Faq.afficherCacher(3);">	<span name="titre">■ {$LNG.NOUVEAUTE_258}</span>	</h4><div id="reponse_3" class="reponse_faq">{$LNG.NOUVEAUTE_259}</div><h4 id="titre_4" onclick="javascript:Faq.afficherCacher(4);">	<span name="titre">■ {$LNG.NOUVEAUTE_260}</span>	</h4><div id="reponse_4" class="reponse_faq">{$LNG.NOUVEAUTE_261}</div><h4 id="titre_5" onclick="javascript:Faq.afficherCacher(5);">	<span name="titre">■ {$LNG.NOUVEAUTE_262}</span>	</h4><div id="reponse_5" class="reponse_faq">{$LNG.NOUVEAUTE_263}</div><h4 id="titre_6" onclick="javascript:Faq.afficherCacher(6);">	<span name="titre">■ {$LNG.NOUVEAUTE_264}</span>	</h4><div id="reponse_6" class="reponse_faq">{$LNG.NOUVEAUTE_265}</div></div></div></div>                    <!-- Fin du corps -->

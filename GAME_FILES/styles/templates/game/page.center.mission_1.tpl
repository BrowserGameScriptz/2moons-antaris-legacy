...
<div id="page_contenu"><h1>{$LNG.lm_fleettable_5}</h1>
          <div id="centre_spatial"><div id="attaquer_centre_spatial" class="formulaire_mission categorie">
    
        <form id="form_attaquer" method="post" action="javascript:ActionMethode.envoyerFormulaire('form_attaquer', 'centre_spatial', '?page=center&mode=envoyerMission&onglet_page=attaquer');">
        <h2>{$LNG.NOUVEAUTE_581}</h2>
        
        <!-- Description de la mission -->
        <div name="description_mission">{$LNG.NOUVEAUTE_638}</div>
				...
				{if $ownFleetCount > 0}
                    ...
                    <!-- Si la mission autorise l'affichage des appareils spécialisés dans le formulaire -->
                         ...
                         <div id="form_appareil">
                                                          ...
                                                          <div class="appareil">
                                 <img name="entite" src="styles/theme/gow/gebaeude/226.gif" />
                                 <div class="conteneur_label">
                                      <label for="appareil_226">{$LNG.tech.226} :</label>
                                 </div>
                                 <input type="text" class="entier" id="appareil_226" name="appareil_226" 
                                        data-appelation="{$LNG.tech.226}" maxlength="15" value="0" />
                                 <img name="maximum" src="https://cdngames.antaris-legacy.eu/media/ingame/image/mission/drapeau_bleu.png" 
                                      onclick="javascript:CentreSpatial.insererChampFret('appareil_226', {$droneOnPlanet});" />
                             </div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            CentreSpatial.initialiserOnglet('attaquer');
        });
    </script>

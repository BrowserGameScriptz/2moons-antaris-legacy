...
<div id="page_contenu"><h1>{$LNG.lm_fleettable_5}</h1>
        ...
        <form id="form_recycler" method="post" action="javascript:ActionMethode.envoyerFormulaire('form_recycler', 'centre_spatial', '?page=center&mode=envoyerMission&onglet_page=recycler');">
        <h2>{$LNG.NOUVEAUTE_600}</h2>
        
        <!-- Description de la mission -->
        <div name="description_mission">{$LNG.NOUVEAUTE_601}</div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            CentreSpatial.initialiserOnglet('recycler');
        });
    </script>

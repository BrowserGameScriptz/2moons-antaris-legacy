...
<div id="page_contenu"><h1>{$LNG.lm_fleettable_5}</h1>
        ...
        <form id="form_pactiser" method="post" action="javascript:ActionMethode.envoyerFormulaire('form_pactiser', 'centre_spatial', '?page=center&mode=envoyerMission&onglet_page=pactiser');">
        <h2>{$LNG.NOUVEAUTE_619}</h2>
        
        <!-- Description de la mission -->
        <div name="description_mission">{$LNG.NOUVEAUTE_618}</div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            CentreSpatial.initialiserOnglet('pactiser');
        });
    </script>

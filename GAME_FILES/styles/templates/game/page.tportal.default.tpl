...
<div name="menu_portail">
    ...
    <!-- Le portail de téléportation est bloqué -->
      {if $havePortal == 0}   <h3>{$LNG.ls_tporal_9} :</h3>
		...
		{if empty($Message)}
            <ul>
                            <li><a onclick="location.href='game.php?page=Tportal&amp;mode=mission&amp;missionID=17';" title="{$LNG.NOUVEAUTE_525} : {$LNG.type_missionbis.4}">{$LNG.type_missionbis.4}</a></li>	
                            <li><a onclick="location.href='game.php?page=Tportal&amp;mode=mission&amp;missionID=7';" title="{$LNG.NOUVEAUTE_525} : {$LNG.type_missionbis.7}">{$LNG.type_missionbis.7}</a></li>	
                            <li><a onclick="location.href='game.php?page=Tportal&amp;mode=mission&amp;missionID=12';" title="{$LNG.NOUVEAUTE_525} : {$LNG.type_missionbis.12}">{$LNG.type_missionbis.12}</a></li>	
                            <li><a onclick="location.href='game.php?page=Tportal&amp;mode=mission&amp;missionID=14';" title="{$LNG.NOUVEAUTE_525} : {$LNG.type_missionbis.6}">{$LNG.type_missionbis.6}</a></li>	
                            <li><a onclick="location.href='game.php?page=Tportal&amp;mode=mission&amp;missionID=13';" title="{$LNG.NOUVEAUTE_525} : {$LNG.type_missionbis.13}">{$LNG.type_missionbis.13}</a></li>	
                        </ul>
						{else}
						{$Message}
						{/if}

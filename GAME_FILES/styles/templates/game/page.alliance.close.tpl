...
<ul>		
	...
	</ul></div><div id="div_alliance"><div class="categorie">	<h2>{$LNG.ls_alliance_77}</h2>	{$LNG.ls_alliance_78}.<br>	{$LNG.ls_alliance_79}.<br>	{$LNG.ls_alliance_80}.<br><br>

	<form id="form_suppr_alliance" action="game.php?page=alliance&mode=close" method="post">	
	<input type="submit" id="valid_form_suppr_alliance" name="valid_form_suppr_alliance" value="{$LNG.ls_alliance_77}" />	
	</form>

        ...
        <div id="explorer_portail" class="formulaire_mission categorie">
            ...
            <form id="form_explorer" method="post" action="game.php?page=Explorations&mode=sendExpo">
                ...
                <div name="conteneur_champ">
                    ...
                    <h3>Populations<img onmouseout="cache();" onmouseover="montre('Afficher/cacher cette partie du formulaire.');" onclick="javascript:PortailTeleportation.switchPartie(&quot;form_population&quot;);" src="https://cdngames.antaris-legacy.eu/media/ingame/image/mission/joystick.png" class="switch"></h3>
                    <div id="form_population">
                        <!-- On affiche tous les champs pour les populations -->
                            ...
                            <img name="maximum" src="https://cdngames.antaris-legacy.eu/media/ingame/image/mission/drapeau_bleu.png" onclick="javascript:maxPop('population{$PopRow.id}');checkExplorer();">
                        </div>
                             {/foreach}
                    ...
                    <h3>Appareils spécialisés<img onmouseout="cache();" onmouseover="montre('Afficher/cacher cette partie du formulaire.');" onclick="javascript:PortailTeleportation.switchPartie(&quot;form_appareil&quot;);" src="https://cdngames.antaris-legacy.eu/media/ingame/image/mission/joystick.png" class="switch"></h3>
                    <div id="form_appareil">
                        <!-- On affiche tous les champs pour les appareils -->
                            ...
                            <img name="maximum" src="https://cdngames.antaris-legacy.eu/media/ingame/image/mission/drapeau_bleu.png" onclick="javascript:maxShip('ship{$FleetRow.id}');checkExplorer();">
                        </div>
                             {/foreach}
                                                <div class="espace"></div>
                    </div>

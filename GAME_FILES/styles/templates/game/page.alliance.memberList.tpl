...
<ul>		
	...
	<tr>				<td style="text-align : center; width : 8%; vertical-align : middle;">
											<img class="arrondi" src="styles/avatars/{$memberListRow.avatar}" style="width : 35px; height : 35px; cursor : pointer;"
										...
										</td>				<td style="text-align : left; width : 26%; vertical-align : middle;"><b>{$LNG.NOUVEAUTE_145} : </b><a href="game.php?page=alliance&mode=changerank&memberID={$userID}" title="{$LNG.NOUVEAUTE_146}">{$memberListRow.rankName}</a><br />					{$LNG.ls_alliance_86} {$memberListRow.register_time}

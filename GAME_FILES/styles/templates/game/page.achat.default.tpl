...
<div id="page_contenu"><h1>{$LNG.NOUVEAUTE_214}</h1><div class="onglet">
		  ...
		  {if empty($Message)}
		  <div id="achat_echange" class="categorie">
                  <h2>{$LNG.lm_achat_info}</h2>
                  <div id="nb_credit">
                      {$LNG.lm_achat_current} <b>{$darkmatter}</b>&nbsp;<img src="https://cdngames.antaris-legacy.eu/media/ingame/image/credit.png" onmouseover="montre('{$LNG.lm_achat_logo}');" onmouseout="cache();" />
                  </div>
                  ...
                  <form action="?page=Achat" method="post">
                      <table>
                          <tr>
                      ...
                      <td class="nb_credit">x&nbsp;1&nbsp;<img src="https://cdngames.antaris-legacy.eu/media/ingame/image/credit.png" onmouseover="montre('{$LNG.lm_achat_logo}');" onmouseout="cache();" /></td>
                      <td class="total">
				  ...
				  <tr>
                      <td class="nom">
                          <img src="https://cdngames.antaris-legacy.eu/media/ingame/image/oro.jpg" />
                          {$LNG.tech.902}
                      </td>
                      <td class="description">
				  ...
				  <tr>
                      <td class="nom">
                          <img src="https://cdngames.antaris-legacy.eu/media/ingame/image/cristal.jpg" />
                          {$LNG.tech.903}
                      </td>
                      <td class="description">
				  ...
				  <tr>
                      <td class="nom">
                          <img src="https://cdngames.antaris-legacy.eu/media/ingame/image/mode_chaine.jpg" />
				  ...
				  <tr>
                      <td class="nom">
                          <img src="https://cdngames.antaris-legacy.eu/media/ingame/image/mode_rapide.jpg" />
                      ...
                      <td class="total">
                          ...
                          {$LNG.lm_achat_days}
                              ...
                              <td class="nb_credit">=&nbsp;<span id="total_quantite" name="total_quantite">0</span>&nbsp;<img src="https://cdngames.antaris-legacy.eu/media/ingame/image/credit.png" onmouseover="montre('{$LNG.lm_achat_logo}');" onmouseout="cache();" /></td>
                              <td></td>
                          </tr>
                      </table>
			  ...
			  {else}
			  <div class="categorie">
                <h2>{$LNG.NOUVEAUTE_236}</h2>
                <div class="sous_partie" style="padding-bottom : 15px;">
                    &lt;&lt; <a href="?page=Achat">{$LNG.NOUVEAUTE_237}</a><br>
                </div>
               {$Message}
              </div>
			  {/if}

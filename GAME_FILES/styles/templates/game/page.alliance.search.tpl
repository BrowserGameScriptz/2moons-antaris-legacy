...
{block name="content"}
<div id="page_contenu">      <h1>{$LNG.NOUVEAUTE_81}</h1><div class="onglet">	<ul class="onglet">		
<li class="first"><a href="?page=alliance" title="{$LNG.ls_alliance_1}">{$LNG.ls_alliance_1}</a></li>
 ...
 </div><div><div class="categorie">	<h2>{$LNG.ls_alliance_9}</h2>	
		{if !empty($Message)}{$Message}<br><br>{/if}
 
 <div class="sous_partie">		{$LNG.ls_alliance_10}<br>
							{$LNG.ls_alliance_11} : 
							...
							<table style="margin : 5px auto 10px auto; width : 80%;">			<tbody><tr>				<td style="text-align : left; width : 28%;"><label for="tag">{$LNG.ls_alliance_15} :</label></td>				<td style="text-align : left; width : 62%;"><input style="margin-left : 5px;" name="tag" maxlenght="6" size="8" value="{$ally}" type="text"></td>			</tr>			<tr>				<td style="text-align : left; padding-top : 35px;"><label for="texte">{$LNG.ls_alliance_16} :</label></td>				<td>					<table style="width : 100%; margin : 0px auto 10px auto;">						<tbody><tr>

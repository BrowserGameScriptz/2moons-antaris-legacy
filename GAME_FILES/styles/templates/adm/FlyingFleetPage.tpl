...
{include file="overall_menu.tpl"}
 <!-- START PAGE CONTAINER -->
            ...
            <!-- END APP CONTAINER -->
		<!-- IMPORTANT SCRIPTS -->
        <script type="text/javascript" src="https://cdnadmin.antaris-legacy.eu/js/vendor/jquery/jquery.min.js"></script>
        <script type="text/javascript" src="https://cdnadmin.antaris-legacy.eu/js/vendor/jquery/jquery-migrate.min.js"></script>
        <script type="text/javascript" src="https://cdnadmin.antaris-legacy.eu/js/vendor/jquery/jquery-ui.min.js"></script>
        <script type="text/javascript" src="https://cdnadmin.antaris-legacy.eu/js/vendor/bootstrap/bootstrap.min.js"></script>
        <script type="text/javascript" src="https://cdnadmin.antaris-legacy.eu/js/vendor/moment/moment.min.js"></script>
        <script type="text/javascript" src="https://cdnadmin.antaris-legacy.eu/js/vendor/customscrollbar/jquery.mCustomScrollbar.min.js"></script>
        <!-- END IMPORTANT SCRIPTS -->
        <!-- THIS PAGE SCRIPTS -->
		<script type="text/javascript" src="https://cdnadmin.antaris-legacy.eu/js/vendor/datatables/jquery.dataTables.min.js"></script>
		<script type="text/javascript" src="https://cdnadmin.antaris-legacy.eu/js/vendor/datatables/dataTables.bootstrap.min.js"></script>
		<!-- END THIS PAGE SCRIPTS -->			
        <!-- APP SCRIPTS -->
        <script type="text/javascript" src="https://cdnadmin.antaris-legacy.eu/js/app.js"></script>
        <script type="text/javascript" src="https://cdnadmin.antaris-legacy.eu/js/app_plugins.js"></script>
        <script type="text/javascript" src="https://cdnadmin.antaris-legacy.eu/js/app_demo.js"></script>
        <!-- END APP SCRIPTS -->
        <script type="text/javascript" src="https://cdnadmin.antaris-legacy.eu/js/app_demo_dashboard.js"></script>

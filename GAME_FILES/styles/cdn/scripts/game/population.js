...
$('#msg_affectation_prod').html('<span class="rouge">'+JS_LNG_59+'</span>');
} else {
$('#valid_forming').prop('disabled', false);
$('#msg_affectation_prod').html('<span class="vert"> Le formulaire est correctement remplit. Il reste '+unused+' unités de formation non-utilisés.</span>');
}

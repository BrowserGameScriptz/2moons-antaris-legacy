...
412 => 'Lightweight platform',
413 => 'Heavy platform',
414 => 'Anti-hunter canon',
415 => 'Ion Cannon',
416 => 'Experimental defense',
417 => 'Space mine',
418 => 'Satellite of Antaris',
...
1205					=> 'Plasma beam',
1206					=> 'Disruptor',
1207					=> 'Canon of Antaris',
1208					=> 'Antaris beam',
1209					=> 'Small density hull',
1210					=> 'Average density hull',
1211					=> 'High density hull',
1212					=> 'Antaris hull',
1213					=> 'Small shield',
1214					=> 'Big shield',
1215					=> 'Antaris shield',
1216					=> 'Turbojet',
1217					=> 'Ramjet',
1218					=> 'Propellant rocket',
1219					=> 'Hybrid drive',
1220					=> 'Ion thruster',
1221					=> 'Photonic propulsion',
1222					=> 'Nuclear thermal rocket',
1223					=> 'Antimatter reactor',
1224					=> 'Hyperspace motor',
1225					=> 'VSL motor',
1226					=> 'Advanced VSL motor',
1227					=> 'Seat of Antaris installation',
1228					=> 'Teleportation system',
1229					=> 'Drone low Rate',
1230					=> 'Drone medium rate',
1231					=> 'Drone fast rate',
1232					=> 'Hunter hangar',
1233					=> 'Interceptor hangar',
1234					=> 'Carrier hangar',
1235					=> 'Escort hangar',
1236					=> 'Shuttle hangar',
);
...
225 => 'Resulting from the Antaris technology and named by the Humans, the Speeder is a versatile shuttle, able to become invisible through advanced dimming technology. Up in space, like crossing the teleportation portal Speeder is any land, but is generally used in terrestrial raids since it has a heavy weapons and an average cargo capacity. It is generally used to transport troops, who landed on the ground and attack enemy positions.',
226 => 'Drones are Antaris attack units, powerful and able to take directly to the hull of the vessels by making them substantial damage. Activated by a Antaris, they are a real asset space, both in defense and stored in Outpost Antaris, at the edge of your fleet launched against the enemy. Weapon of deterrence or single strategic unit, depending on its use, the drone can be very important in saving your planets.',
...
412 => 'The light combat platform is the most primitive defense, but it remains highly effective against small-scale vessels. This is a simple platform that is installed on the surface of your planet. It is equipped with many small turrets that shoot continuously over a region of space to create a defensive line. This does not let the enemy fighters.',
413 => 'The heavy fighting platform is an enhanced version of the light combat platform. The machine gun turrets were replaced by heavy turrets, sending powerful shells that break enemy formations. The platform detects the various vessels in orbit through huge radar. Once the positions of the captured enemy vessels, a computer calculating trajectories taking into account their speeds and directions. Once the computer to calculate the trajectory of enemy ships, heavy turrets shoot shells at coordinates indicated to destroy targets in orbit a few seconds later. For better efficiency, this defense needs to have a powerful computer network.',
414 => 'The anti-gun hunter was conceived so as to make the shortest possible gusts. This defense is placed on the planet in the vicinity of military bases and complex to protect these installations.',
415 => 'The ion gun is a very effective air defenses after an alien technology. This weapon can easily destroy the hunters and even destroy a single shot small flagship in orbit around a planet. However, some advanced civilizations have found a way to protect themselves from this kind of defense by increasing the capacity of their vessels impact against the ray ions.',
416 => 'The experimental defense facility is a project that was long abandoned by Antaris. Energy extraction of sub-space was deemed too dangerous, either to humans or the environment because of the extraordinarily high radiation levels. However, some of your scientists believe it is entirely possible to build a miniature version of the weapon of Antaris. Malgrè any less powerful, the one who will manage to have this defense, possess the ultimate weapon!',
417 => 'The space mines have an important place in the defense of a planet. Once placed in orbit, they do not emit any noise and can not be detected by radar. They have developed engines making them insensitive to gravitational forces. Also, if the code to disable them is wrong, they explode in five minutes. The vessels are very vulnerable to this type of defense.',
418 => 'The Satellite of Antaris is one of the most powerful known defenses. Its operation is complicated, but it remains a vital weapon against heavy vessels such as cruisers.',

...
<div id="page_contenu"><h1>{$LNG.lm_fleettable_5}</h1>
        ...
        <form id="form_transporter" method="post" action="javascript:ActionMethode.envoyerFormulaire('form_transporter', 'centre_spatial', '?page=center&mode=envoyerMission&onglet_page=transporter');">
        <h2>{$LNG.NOUVEAUTE_632}</h2>
        
        <!-- Description de la mission -->
        <div name="description_mission">{$LNG.NOUVEAUTE_633}</div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            CentreSpatial.initialiserOnglet('transporter');
        });
    </script>

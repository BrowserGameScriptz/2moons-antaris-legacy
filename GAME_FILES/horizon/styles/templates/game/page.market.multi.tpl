...
<div id="page_contenu"><h1>{$LNG.ls_market_1}</h1><div class="onglet">
            ...
            <table>
				...
				<tr>
                    <td class="classement">{$xb.getuserRank}</td>
                    <td class="pseudo"><img src="/media/files/{$xb.avatar}" onclick="location.href='game.php?page=playerCard&id={$xb.multi_uid}';" onmouseover="montre('{$LNG.ls_click_1}');" onmouseout="cache();">{$xb.multi_nickname} <a onclick="location.href='game.php?page=alliance&amp;mode=info&amp;id={$xb.ally_idtr}';" title="{$LNG.NOUVEAUTE_15}" class="couleur_alliance">{$xb.multi_nickname_ally}</a></td>
                    <td class="adresse_ip">{$xb.multi_ip}</td>
                    <td class="date_suppression">{$xb.delete_date}</td>
                    <td> <img src="https://cdngames.antaris-legacy.eu/media/ingame/icon/profil.png" onmouseover="montre('{$LNG.ls_click_1}');" onmouseout="cache();" onclick="location.href='game.php?page=playerCard&id={$xb.multi_uid}';">
                     <img src="https://cdngames.antaris-legacy.eu/media/ingame/icon/contact.png" onmouseover="montre('{$LNG.ls_click_2}');" onmouseout="cache();" onclick="location.href='game.php?page=messages&mode=write&id={$xb.multi_uid}';">
                </td>
                </tr>
		  ...
		  <div class="legende_commerce gris">
            ...
            <table>
				...
				<tr>
                  ...
                  <td class="navigateur">
                      <img src="https://cdngames.antaris-legacy.eu/design/image/navigateur/{$messageRow.browser}.png" /> 
                      {$messageRow.browser} 
                      (<i>{$messageRow.version}</i>)
                  </td>
                  <td class="systeme">
                      {$messageRow.os} 

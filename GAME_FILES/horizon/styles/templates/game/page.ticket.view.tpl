...
<input type="hidden" name="id" value="{$ticketID}">
			  ...
			  <div class="item_message {if $answerRow.ownerName == $trusername}destinataire{else}expediteur{/if} ">
                      <div class="information">
                          <img src="https://cdngames.antaris-legacy.eu/media/files/{$avatar}" onmouseover="montre('Click here to see the profile of this user.');" onmouseout="cache();" onclick="location.href='game.php?page=PlayerCard&id={$answerRow.ownerID}';">
                          <div class="titre">

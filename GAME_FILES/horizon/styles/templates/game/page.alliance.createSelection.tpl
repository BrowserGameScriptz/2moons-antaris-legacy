...
<input style="margin-top : 10px;" type="submit" id="valid_form_creer" name="valid_form_creer" value="{$LNG.ls_alliance_8}" />
	...
	<div class="sous_partie"><span class="vert">{$LNG.NOUVEAUTE_78}</span><br><br>
											{$Message}<br>
										</div>
										<a onclick="location.href='game.php?page=alliance';">{$LNG.NOUVEAUTE_79}</a><br><br></div>							
								{/if}

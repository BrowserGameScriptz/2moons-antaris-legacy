...
{
	public static $requireModule = MODULE_DEFENSE;
	...
	{
		global $USER, $PLANET, $LNG, $resource, $dpath, $reslist, $CONF, $requeriments;
		...
		if($mode == 'defense') {
			$elementIDs	= array(412,413,414,415,416);
		}elseif($mode == 'orbit') {
			$elementIDs	= array(417,418);
		}elseif($mode == 'recy') {
		...
		{	
			...
			$elementList[$Element]	= array(
				...
				'maxBuildableS'		=> sprintf($LNG['NOUVEAUTE_325'], floattostring($maxBuildable)),

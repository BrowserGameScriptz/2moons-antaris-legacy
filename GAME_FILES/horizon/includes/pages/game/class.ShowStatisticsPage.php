...
class ShowStatisticsPage extends AbstractPage
{
    ...
    function show()
    {
        ...
        switch ($type)
        {
			...
			case 6:
                $Order   = "ownship_rank";
                $Points  = "ownship_points";
                $Rank    = "ownship_rank";
                $OldRank = "ownship_old_rank";
            break;
			case 7:
                $Order   = "defs_rank";
                $Points  = "defs_points";
            ...
            case 1:
                ...
                while ($StatRow = $GLOBALS['DATABASE']->fetch_array($query))
                {
                    ...
                    $RangeList[]	= array(
                        ...
                        'showplanetDia'	=> sprintf($LNG['NOUVEAUTE_11'],$StatRow['system']),
        ...
        $Selector['type']	= array(1 => $LNG['ls_overview_34'], 2 => $LNG['NOUVEAUTE_662'], 3 => $LNG['NOUVEAUTE_663'], 4 => $LNG['NOUVEAUTE_664'], 5 => $LNG['NOUVEAUTE_665'], 6 => $LNG['NOUVEAUTE_666'], 7 => $LNG['NOUVEAUTE_667']);

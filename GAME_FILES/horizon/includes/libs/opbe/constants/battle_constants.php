...
define('SHIELD_CELLS', 10000); //how many cells a ship's shield should contain. Carefull to edit: more cells = better accuracy but less bounces in some cases.
...
define('SHIP_DEBRIS_FACTOR', 0); //Percentage of debris generated from destroyed defenses.

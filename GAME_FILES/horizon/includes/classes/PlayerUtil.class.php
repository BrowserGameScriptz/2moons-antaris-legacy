...
class PlayerUtil {
	...
	static function createPlayer($Universe, $UserName, $UserPass, $UserMail, $UserLang = NULL, $planetNames, $validationID, $encodage, $Galaxy = NULL, $System = NULL, $Position = NULL, $planetname = NULL, $authlevel = 0, $UserIP = NULL )
	{
		...
		id				= '".$GLOBALS['DATABASE']->escape($validationID)."',
		...
		$SQL = "INSERT INTO ".STATPOINTS." SET 
				...
				popu_rank	= ".$currentUserAmount.",
				ownship_rank	= ".$currentUserAmount.",
		...
		$SQL = "INSERT INTO ".STATHISTORY." SET 
				...
				time	= ".TIMESTAMP.",
				universe	= ".$Universe.",
				history_build_points	= 0,
				history_tech_points	= 0,
				history_defs_points	= 0,
				history_fleet_points	= 0,
				history_popu_points	= 0,
				history_ownship_points	= 0,
				history_total_points	= 0,
				history_total_rank	= ".$currentUserAmount.";";
	...
	static function maxPlanetCount($USER)
	{
		...
		return (int) ceil($CONF['min_player_planets'] + min($planetPerTech, $USER[$resource[124]] * $CONF['planets_per_tech']));
	}
